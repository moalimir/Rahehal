...
export const teamInvitationTransitions: readonly Transition<TeamInvitationState>[] = [
  { from: "sent", to: "viewed", actors: ["solver"], preconditions: ["recipient-authorized", "not-expired"], sideEffects: ["record-viewed-at"], notification: "", audit: "team-invitation.viewed", retry: "idempotent" },
  { from: "sent", to: "accepted", actors: ["solver"], preconditions: ["recipient-authorized", "not-expired"], sideEffects: ["create-membership", "add-workspace"], notification: "مدیران تیم", audit: "team-invitation.accepted", retry: "idempotent" },
  { from: "viewed", to: "accepted", actors: ["solver"], preconditions: ["recipient-authorized", "not-expired"], sideEffects: ["create-membership", "add-workspace"], notification: "مدیران تیم", audit: "team-invitation.accepted", retry: "idempotent" },
  { from: "sent", to: "declined", actors: ["solver"], preconditions: ["recipient-authorized", "reason-recorded"], sideEffects: ["close-invitation"], notification: "مدیران تیم", audit: "team-invitation.declined", retry: "idempotent" },
  { from: "viewed", to: "declined", actors: ["solver"], preconditions: ["recipient-authorized", "reason-recorded"], sideEffects: ["close-invitation"], notification: "مدیران تیم", audit: "team-invitation.declined", retry: "idempotent" },
  { from: "sent", to: "revoked", actors: ["owner", "admin", "team-manager"], preconditions: ["sender-authorized"], sideEffects: ["revoke-access-token"], notification: "دعوت‌شونده", audit: "team-invitation.revoked", retry: "idempotent" },
  { from: "viewed", to: "revoked", actors: ["owner", "admin", "team-manager"], preconditions: ["sender-authorized"], sideEffects: ["revoke-access-token"], notification: "دعوت‌شونده", audit: "team-invitation.revoked", retry: "idempotent" },
  { from: "sent", to: "expired", actors: ["ops"], preconditions: ["deadline-passed"], sideEffects: ["close-invitation"], notification: "دو طرف دعوت", audit: "team-invitation.expired", retry: "idempotent" },
  { from: "viewed", to: "expired", actors: ["ops"], preconditions: ["deadline-passed"], sideEffects: ["close-invitation"], notification: "دو طرف دعوت", audit: "team-invitation.expired", retry: "idempotent" },
];
...
export const membershipRequestTransitions: readonly Transition<MembershipRequestState>[] = [
  { from: "requested", to: "accepted", actors: ["owner", "admin", "team-manager"], preconditions: ["scope-approved"], sideEffects: ["create-membership", "update-roster"], notification: "متقاضی عضویت", audit: "membership-request.accepted", retry: "idempotent" },
  { from: "requested", to: "rejected", actors: ["owner", "admin", "team-manager"], preconditions: ["decision-confirmed"], sideEffects: ["close-request"], notification: "متقاضی عضویت", audit: "membership-request.rejected", retry: "idempotent" },
  { from: "requested", to: "withdrawn", actors: ["solver"], preconditions: ["requester-authorized"], sideEffects: ["close-request"], notification: "مدیران تیم", audit: "membership-request.withdrawn", retry: "idempotent" },
  { from: "requested", to: "expired", actors: ["ops"], preconditions: ["deadline-passed"], sideEffects: ["close-request"], notification: "دو طرف درخواست", audit: "membership-request.expired", retry: "idempotent" },
];
...
export const verificationTransitions: readonly Transition<VerificationState>[] = [
  { from: "not_started", to: "draft", actors: ["solver", "owner", "admin"], preconditions: [], sideEffects: ["create-document-checklist"], notification: "", audit: "verification.draft.created", retry: "idempotent" },
  { from: "draft", to: "submitted", actors: ["solver", "owner", "admin"], preconditions: ["documents-valid"], sideEffects: ["lock-submission", "create-receipt"], notification: "عملیات", audit: "verification.submitted", retry: "idempotent" },
  { from: "needs_revision", to: "submitted", actors: ["solver", "owner", "admin"], preconditions: ["documents-valid", "revision-addressed"], sideEffects: ["create-revision", "create-receipt"], notification: "عملیات", audit: "verification.resubmitted", retry: "idempotent" },
  { from: "submitted", to: "under_review", actors: ["ops"], preconditions: ["submission-locked"], sideEffects: ["open-review"], notification: "فضای متقاضی", audit: "verification.review.started", retry: "idempotent" },
  { from: "under_review", to: "verified", actors: ["ops"], preconditions: ["evidence-approved"], sideEffects: ["issue-verification-evidence"], notification: "فضای متقاضی", audit: "verification.verified", retry: "manual-review" },
  { from: "under_review", to: "needs_revision", actors: ["ops"], preconditions: ["reason-recorded"], sideEffects: ["open-revision"], notification: "فضای متقاضی", audit: "verification.revision.requested", retry: "manual-review" },
  { from: "under_review", to: "rejected", actors: ["ops"], preconditions: ["reason-recorded"], sideEffects: ["lock-outcome"], notification: "فضای متقاضی", audit: "verification.rejected", retry: "manual-review" },
];
