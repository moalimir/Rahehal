...
/**
 * The public sibling of `CONNECTED_RECORD_PATH`. A published challenge's id is
 * generated by the server, so it can never be a pre-generated static path; the
 * id travels as `?id=chl_…` and the page resolves it on mount.
 */
