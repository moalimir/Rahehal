...
| 15 | [15_PRODUCT_REQUIREMENTS](15_PRODUCT_REQUIREMENTS.md) | *(ref)* FR/NFR requirement catalog, success measures, MVP acceptance criteria |
...
| 45 | [45_AI_AND_MATCHING](45_AI_AND_MATCHING.md) | *(deferred)* AI & matching, AI-ready stack additions, embeddings, guardrails |
...
| 85 | [85_DEVELOPMENT_GUIDE](85_DEVELOPMENT_GUIDE.md) | *(ref)* Setup, commands, conventions, backend-safe gateway pattern, CI pipeline, DoD |
| 90 | [90_REQUIREMENTS_TRACEABILITY](90_REQUIREMENTS_TRACEABILITY.md) | *(ref)* Requirement → current evidence → status → phase matrix |
| 95 | [95_RISKS_AND_OPEN_QUESTIONS](95_RISKS_AND_OPEN_QUESTIONS.md) | *(ref)* Risk register (R-01…R-16), P0 decisions, open questions, decision-log template |
