    ...
    if (!networkRuntime) {
      config.plugins.push(
        new webpack.NormalModuleReplacementPlugin(
          /^@\/(?:components\/(?:challenge-flow\/live-call-controls|platform-approval-queue|public-challenge-(?:catalogue|record))|lib\/(?:api\/http|challenges\/adapters\/network(?:-governance|-public-challenges)?))$/,
